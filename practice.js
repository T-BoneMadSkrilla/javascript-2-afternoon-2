...
function divider (numbersArray){
  ...
  var oddsarr = [];
    ...
    for(let i = 0; i < numbersArray.length; i++){
      ...
      if(numbersArray[i] % 2 === 0){evensarr.push(numbersArray[i])}
      else{ oddsarr.push(numbersArray[i])}
    }
var dividedarr = [evensarr, oddsarr,]
return dividedarr;
}//Code Here
...
function finder (arr) {
  ...
  for(let i = 0; i < arr.length; i++){
    if(arr[i] === getRandomArbitrary()){return true}
  }
return false;
}//Code Here
...
for(let i = 0; i < myGroceryList; i++){
  ...
  if(myGroceryList[i] === item){updatedGroceryList.push(myGroceryList[i])}
...
function addItem (myGroceryList, item){
    ...
    var updatedGroceryList2 = [];
    updatedGroceryList2.push(item)
    updatedGroceryList2.push(myGroceryList)
    return updatedGroceryList2;
